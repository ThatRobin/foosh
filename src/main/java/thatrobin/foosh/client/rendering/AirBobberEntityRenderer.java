...
public class AirBobberEntityRenderer extends EntityRenderer<AirBobberEntity> {
    private static final Identifier TEXTURE = new Identifier("foosh", "textures/entity/end_hook.png");
    private static final RenderLayer LAYER;

    public AirBobberEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
    }

    public void render(AirBobberEntity fishingBobberEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        ...
        if (playerEntity != null) {
            ...
            if (!itemStack.isOf(FooshItems.END_ROD)) {
                j = -j;
            }
    ...
    public Identifier getTexture(AirBobberEntity fishingBobberEntity) {
        return TEXTURE;
    }
