...
public class GlassBottleFishItem extends GlassBottleItem {
    public GlassBottleFishItem(Settings settings) {
        super(settings);
    }
            ...
            if (hitResult.getType() == HitResult.Type.MISS) {
                ...
                if (hitResult.getType() == HitResult.Type.BLOCK) {
                    ...
                    if (world.getFluidState(blockPos).isIn(FluidTags.WATER)) {
                        ...
                        return TypedActionResult.success(this.fill(itemStack, user, PotionUtil.setPotion(new ItemStack(FooshItems.GLASSFISH_POTION), Potions.WATER)), world.isClient());
                    }
                }
